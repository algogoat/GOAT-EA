...
| AUTH-148-03 | Persistent backend authorization without reinitializing strategy charts | Superseded by [backend PR1669](https://github.com/algogoat/goatai/pull/1669), Claude review/release lane | Preserve credential bindings; separate entitlement and build approval; explicit revocation. EA startup continuity is AUTH-148-04 |
| AUTH-148-04 | Management-only boot and removal of compiled build expiry | R5/R6/R2 draft candidates; cold demo restart and independent review outstanding | [R4 qualification](docs/operations/MANAGEMENT-ONLY-R4-QUALIFICATION.md): 177 portable checks, 18 native tester cases, exact 10-deal R2 tester comparison; all three compile cleanly; no deployment |

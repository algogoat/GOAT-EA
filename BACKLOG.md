...
| AUTH-148-04 | Management-only boot and removal of compiled build expiry | Review candidate; native restart rehearsal outstanding | [Behavior, restart limits, tests and coordinated rollout](docs/operations/MANAGEMENT-ONLY-BOOT.md); 60 production-function simulations passed, native compile clean; no deployment |
